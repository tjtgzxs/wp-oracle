...
<div id="getting_started" class="mazino-tab-pane active">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="mazino-info-title text-center"><?php esc_html_e('About the Mazino theme', 'mazino'); ?><?php if (!empty($mazino['Version'])): ?> <sup id="mazino-theme-version"><?php echo esc_html($mazino['Version']); ?> </sup><?php endif; ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
